  ...
  return (
    ...
    >
      <div
        data-aos="zoom-in"
        data-aos-delay="50"
        className="lg:w[15%]w-full flex flex-col justify-center 1g:items-start items-center gap-[20px]"
      >
        ...
        <button className="bg-themepurple hover:bg-themeyellow text-white hover: text-black px-8 py-3 rounded-1g font-semibold mt-[60px]">
          VIEW ALL
        </button>
      </div>

      <div className="1g:w-[85%] w-full grid lg:grid-cols-5 grid-cols-1 justify-center items-start gap-10">
